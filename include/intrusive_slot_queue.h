...
#define SLOT_QUEUE_DATA(ptr, type, field) ((type*)((char*)(ptr)-offsetof(type, field)))
...
public:
  ...
  template <typename F, typename... Args> void iterate(F&& f, Args&&... args) const noexcept {
  ...
  template <typename F, typename... Args> void iterate_r(F&& f, Args&&... args) const noexcept {
